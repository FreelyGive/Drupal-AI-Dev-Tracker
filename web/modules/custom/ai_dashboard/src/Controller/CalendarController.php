...
class CalendarController extends ControllerBase {
  ...
  private function isIssueInCurrentWeek($issue, \DateTime $week_start, \DateTime $week_end) {
    // Primary check: If issue has assignment dates, check if any fall within this week
  ...
  private function getBacklogData() {
    ...
    // Use direct database query to get all AI issues (entity query seems to have caching issues)
    ...
    // Get issues that have assignees (to exclude them) - only for existing nodes
