...
CRON_DAILY="0 5 * * * cd /var/www/html && APP_ROOT=/var/www/html PATH=/usr/local/bin:/usr/bin:/bin drush ia-daily >> /var/log/drush.log 2>&1"
CRON_BIWEEKLY="0 6 1,16 * * cd /var/www/html && APP_ROOT=/var/www/html PATH=/usr/local/bin:/usr/bin:/bin drush ia-biweekly >> /var/log/drush.log 2>&1"
